...
# 🗓 Development Journey (TBI-GEU Internship)
...
![AI Feature](Docs/images/ai-features.png)
...
| Challenge | Solution |
|-----------|----------|
| Frontend and backend communication issues (CORS) | Configured CORS properly and updated allowed origins for deployed frontend URLs. |
...
| AI API integration | Integrated Google Gemini API with proper error handling and response validation. |
| Secure authentication | Implemented JWT authentication and protected routes for authorized access. |


# 📂 Internship Journey (Week-wise Progress)

This project was developed incrementally during the **TBI-GEU Summer Internship Program 2026**. Each week focused on specific milestones, gradually transforming the idea into a fully deployed AI-powered full-stack application.

| Week | Milestone | Status |
|------|-----------|--------|
| ✅ Week 1 | Project selection, problem statement, requirement analysis, technology stack selection, and project planning | Completed |
| ✅ Week 2 | Frontend development including responsive UI design, navigation, and reusable React components | Completed |
| ✅ Week 3 | Wireframing, UI refinement, responsive layouts, and frontend enhancements | Completed |
| ✅ Week 4 | Backend development using Express.js, REST API creation, and frontend-backend integration | Completed |
| ✅ Week 5 | MongoDB Atlas integration, database schema design, and CRUD functionality for crop management | Completed |
| ✅ Week 6 | User authentication using JWT, Google OAuth integration, protected routes, validation, and security implementation | Completed |
| ✅ Week 7 | Google Gemini AI integration, AI Crop Advisory feature, prompt engineering, AI response generation, and error handling | Completed |
| ✅ Week 8 | Complete frontend integration with backend APIs, dashboard implementation, profile management, and application testing | Completed |
| ✅ Week 9 | Cloud deployment using Vercel and Render, CORS configuration, deployment verification, README updates, and peer testing | Completed |
| ✅ Week 10 | Final documentation, GitHub repository cleanup, demo video, presentation (PPT), final README, and capstone project submission | Completed |

      ...
      <main className="mx-auto w-full max-w-7xl flex-1 px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-8 md:grid-cols-2">
          <div className="rounded-2xl bg-white p-6 shadow-xl dark:bg-gray-800">
            ...
            <p className="mt-4 text-gray-700 dark:text-green-100">
        ...
        <div className="mt-10 rounded-3xl border border-yellow-300/20 bg-linear-to-r from-green-900/80 to-emerald-700/80 p-8 text-center shadow-xl">
          ...
          <p className="mt-4 text-lg text-green-100">
            We are committed to supporting farmers through innovative, reliable,
            and user-friendly AI solutions that contribute to sustainable
